export default {
    menus: [ // 菜单相关路由
        ...
        //         { key: '/app/ui/drags', title: '拖拽', component: 'Drags'},
                { key: '/app/ui/galleries', title: '画廊', component: 'Galleries'},
        ...
        // },
        {
            ...
            subs: [
                ...
                { key: '/app/table/adminList', title: '管理员列表', component: 'AsynchronousAdminList'},
                { key: '/app/table/articleList', title: '文章列表', component: 'AsynchronousArticleList'},
            ],
        },
        // {
